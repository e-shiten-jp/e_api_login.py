...
# =========================================================================
# 
# 本スクリプトは、立花証券e支店APIリファレンス
# (https://www.e-shiten.jp/e_api/mfds_json_api_refference.html) に準拠しています。
# 
# リファレンスに記載されている「AuthID」（認証ID）および「秘密鍵を用いた署名/復号」の処理を
# 自動運用向けに安全に行うため、本スクリプトでは生のファイルをサーバー上に残さず、
# 事前に暗号化した設定ファイル（.enc）からメモリ上にのみ展開するセキュアな構造を採用しています。
# =========================================================================
# 
#
# == ご注意: ========================================
